import { isServer as St, unsafeCSS as Ue, LitElement as zi, html as v, nothing as N, svg as X } from "lit";
...
import { isServer as Qa } from "lit-html/is-server.js";
import { classMap as Rr } from "lit/directives/class-map.js";
import { map as Ne } from "lit/directives/map.js";
import { unsafeHTML as Ti } from "lit/directives/unsafe-html.js";
import { repeat as it } from "lit/directives/repeat.js";
const Ei = "/";
function ca(e, t, r) {
  const a = Object.keys(e), n = Pi(a), i = /* @__PURE__ */ Object.create(null);
  return a.forEach((s) => {
  ...
  for (n(0); r < e.length; ) {
    ...
    switch (r++, i) {
      ...
      case Ce.lineFeed:
        ...
        break;
      default:
        i > Ce.maxAsciiCharacter && Ii(i) && n(r);
        break;
    }
  }
  return t.push(a), t;
...
class Xa {
  lineMap;
  getLineMap() {
    return da(this.source), this.lineMap ?? (this.lineMap = Di(this.source));
  }
  /**
...
class Li {
   ...
   */
  getLines() {
    return pa(this.sourceFile), Ri(this.location), this.sourceFile.getLines(this.location);
  }
  /**
   * Helper property to retrieve the source file name
   * @throws When the `sourceFile` is not defined.
...
const ha = NaN, fa = "All files", Ni = "All tests";
function qi(e) {
  const { files: t, testFiles: r, projectRoot: a = "" } = e, n = ca(t, a, (i, s) => new ji(i, s));
  if (r && Object.keys(r).length) {
    const i = ca(r, a, (s, o) => new tn(s, o));
    return Hi(Object.values(n).flatMap((s) => s.mutants), Object.values(i).flatMap((s) => s.tests)), {
      systemUnderTestMetrics: lr(fa, n, Jt),
      testMetrics: lr(Ni, i, br)
    };
  }
  return {
    systemUnderTestMetrics: lr(fa, n, Jt),
...
function lr(e, t, r) {
  ...
  return a.length === 1 && a[0] === "" ? an(e, t[a[0]], r) : rn(e, t, r);
}
function rn(e, t, r) {
  const a = r(Object.values(t)), n = Ui(t, r);
  return new en(e, n, a);
}
function an(e, t, r) {
  return new en(e, [], r([t]), t);
}
function Ui(e, t) {
  const r = Oi(Object.entries(e), (a) => a[0].split("/")[0]);
  return Object.keys(r).map((a) => {
    if (r[a].length > 1 || r[a][0][0] !== a) {
      const n = {};
      return r[a].forEach((i) => n[i[0].substr(a.length + 1)] = i[1]), rn(a, n, t);
    } else {
      const [n, i] = r[a][0];
      return an(n, i, t);
    }
...
function Jt(e) {
  const t = e.flatMap((J) => J.mutants), r = (J) => t.filter((ee) => ee.status === J).length, a = r("Pending"), n = r("Killed"), i = r("Timeout"), s = r("Survived"), o = r("NoCoverage"), c = r("RuntimeError"), f = r("CompileError"), M = r("Ignored"), E = i + n, F = s + o, C = E + s, O = F + E, P = c + f;
  return {
    pending: a,
    killed: n,
    timeout: i,
...
function Zi(e, t, r) {
  ...
  function f(C) {
    C.value instanceof nt ? Promise.resolve(C.value.v).then(M, E) : F(i[0][2], C);
  }
  function M(C) {
    c("next", C);
  }
    ...
    if (!this.closed) {
      ...
      if (Y(M))
        try {
          ...
          i = P instanceof cr ? P.errors : [P];
        }
      var E = this._finalizers;
      if (E) {
        this._finalizers = null;
        try {
          for (var F = st(E), C = F.next(); !C.done; C = F.next()) {
            var O = C.value;
            try {
              ga(O);
            } catch (P) {
              i = i ?? [], P instanceof cr ? i = Ct(Ct([], ot(i)), ot(P.errors)) : i.push(P);
            }
          }
        } catch (P) {
          a = { error: P };
...
var Lr = function(e) {
  ...
  function t(r) {
    ...
    return a.isStopped = !1, r ? (a.destination = r, ln(r) && r.add(a)) : a.destination = Qi, a;
  }
...
var fe = function() {
  ...
  return e.prototype.lift = function(t) {
    ...
    var n = this, i = ts(t) ? t : new xr(t, r, a);
    return Bt(function() {
...
function ts(e) {
  return e && e instanceof Lr || es(e) && ln(e);
}
function rs(e) {
  return Y(e?.lift);
}
...
var as = function(e) {
  ...
  return t.prototype.lift = function(r) {
    ...
    return i || s ? on : (this.currentObservers = null, o.push(r), new ft(function() {
  ...
  return t.prototype.next = function(r) {
    ...
    var a, n;
    return (n = (a = this.source) === null || a === void 0 ? void 0 : a.subscribe(r)) !== null && n !== void 0 ? n : on;
  }, t;
}(un), is = {
  now: function() {
    return Date.now();
...
}(ya), Ur = new ls(os), cs = Ur, dn = new fe(function(e) {
  return e.complete();
});
function pn(e) {
...
function fn(e) {
  return pn(hn(e)) ? e.pop() : void 0;
}
function us(e, t) {
  return typeof hn(e) == "number" ? e.pop() : t;
}
var Hr = function(e) {
...
function vs(e, t) {
  ...
  return Ki(this, void 0, void 0, function() {
    ...
    return nn(this, function(c) {
      switch (c.label) {
        case 0:
          c.trys.push([0, 5, 6, 11]), r = Vi(e), c.label = 1;
        case 1:
          return [4, r.next()];
        case 2:
...
function Ms(e, t) {
  return Cs(t) ? e.apply(void 0, Ct([], ot(t))) : e(t);
}
function As(e) {
...
function zs(e, t, r, a, n, i, s, o) {
  var c = [], f = 0, M = 0, E = !1, F = function() {
    E && !c.length && !f && t.complete();
  }, C = function(P) {
    return f < a ? O(P) : c.push(P);
  }, O = function(P) {
    f++;
    var J = !1;
    Ke(r(P, M++)).subscribe(Qe(t, function(ee) {
      t.next(ee);
    }, function() {
      J = !0;
    }, void 0, function() {
...
var Es = ["addListener", "removeListener"], Ps = ["addEventListener", "removeEventListener"], Fs = ["on", "off"];
function Mt(e, t, r, a) {
  if (Y(r) && (a = r, r = void 0), a)
    return Mt(e, t, r).pipe(As(a));
  var n = ot(Ds(e) ? Ps.map(function(o) {
    return function(c) {
      return e[o](t, c, r);
    };
  }) : Os(e) ? Es.map(wa(e, t)) : Is(e) ? Fs.map(wa(e, t)) : [], 2), i = n[0], s = n[1];
  if (!i && Hr(e))
...
function Bs(e, t, r) {
  r === void 0 && (r = cs);
  var a = -1;
  return pn(t) ? r = t : a = t, new fe(function(n) {
    var i = Ss(e) ? +e - r.now() : e;
    i < 0 && (i = 0);
    var s = 0;
...
function js(e, t) {
  return t === void 0 && (t = Ur), Bs(e, e, t);
}
function Rs() {
  for (var e = [], t = 0; t < arguments.length; t++)
    e[t] = arguments[t];
  var r = fn(e), a = us(e, 1 / 0), n = e;
  return n.length ? n.length === 1 ? Ke(n[0]) : Ts(a)(Mn(n, r)) : dn;
}
function Ls(e) {
...
function Ns(e, t) {
  return t === void 0 && (t = Ur), Ls(js(e, t));
}
function qs(e, t, r) {
...
class Us {
  constructor(t, { target: r, config: a, callback: n, skipInitial: i }) {
    this.t = /* @__PURE__ */ new Set(), this.o = !1, this.i = !1, this.h = t, r !== null && this.t.add(r ?? t), this.l = a, this.o = i ?? this.o, this.callback = n, Qa || (window.ResizeObserver ? (this.u = new ResizeObserver((s) => {
    ...
    var r = function(a) {
      var n = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, s = {}, o = {
          ...
          DFS: function p(d, m, u, g) {
            ...
            for (var z in d)
              if (d.hasOwnProperty(z)) {
                m.call(d, z, d[z], u || z);
                var _ = d[z], Z = o.util.type(_);
                Z === "Object" && !g[w(_)] ? (g[w(_)] = !0, p(_, m, null, g)) : Z === "Array" && !g[w(_)] && (g[w(_)] = !0, p(_, m, z, g));
              }
          }
        },
        plugins: {},
        ...
        tokenize: function(p, d) {
          ...
          var g = new E();
          return F(g, g.head, p), M(p, g, d, g.head, 0), O(g);
        },
        /**
         * @namespace
         * @memberof Prism
      ...
      c.stringify = function p(d, m) {
        ...
        for (var _ in g.attributes)
          z += " " + _ + '="' + (g.attributes[_] || "").replace(/"/g, "&quot;") + '"';
        return "<" + g.tag + ' class="' + g.classes.join(" ") + '"' + z + ">" + g.content + "</" + g.tag + ">";
      };
      function f(p, d, m, u) {
        p.lastIndex = d;
        var g = p.exec(m);
      ...
      function M(p, d, m, u, g, w) {
        for (var z in m)
          if (!(!m.hasOwnProperty(z) || !m[z])) {
            var _ = m[z];
            _ = Array.isArray(_) ? _ : [_];
            for (var Z = 0; Z < _.length; ++Z) {
              if (w && w.cause == z + "," + Z)
                return;
              var U = _[Z], re = U.inside, Se = !!U.lookbehind, we = !!U.greedy, Te = U.alias;
              if (we && !U.pattern.global) {
                var xe = U.pattern.toString().match(/[imsuy]*$/)[0];
                U.pattern = RegExp(U.pattern.source, xe + "g");
              }
                ...
                if (!(j instanceof c)) {
                  ...
                  if (we) {
                    ...
                    for (var l = B; l !== d.tail && (h < at || typeof l.value == "string"); l = l.next)
                      le++, h += l.value.length;
                    le--, j = p.slice(V, h), ce.index -= V;
                  } else if (ce = f(Ee, 0, j, Se), !ce)
                    continue;
                  var b = ce.index, k = ce[0], $ = j.slice(0, b), x = j.slice(b + k.length), y = V + j.length;
                  w && y > w.reach && (w.reach = y);
                  var A = B.prev;
                  $ && (A = F(d, A, $), V += $.length), C(d, A, le);
                  var S = new c(z, re ? o.tokenize(k, re) : k, Te, k);
                  if (B = F(d, A, S), x && F(d, B, x), le > 1) {
                    var I = {
                      cause: z + "," + Z,
                      reach: y
                    };
      ...
      if (!o.manual) {
        ...
        ee === "loading" || ee === "interactive" && P && P.defer ? document.addEventListener("DOMContentLoaded", J) : window.requestAnimationFrame ? window.requestAnimationFrame(J) : window.setTimeout(J, 16);
      }
      return o;
    }(t);
    e.exports && (e.exports = r), typeof ka < "u" && (ka.Prism = r);
  }(ur)), ur.exports;
}
var _a = Ks();
...
function Vs() {
  return Aa || (Aa = 1, function(e) {
    ...
    var s = i(n.typeDeclaration), o = RegExp(i(n.type + " " + n.typeDeclaration + " " + n.contextual + " " + n.other)), c = i(n.typeDeclaration + " " + n.contextual + " " + n.other), f = i(n.type + " " + n.typeDeclaration + " " + n.other), M = a(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2), E = a(/\((?:[^()]|<<self>>)*\)/.source, 2), F = /@?\b[A-Za-z_]\w*\b/.source, C = t(/<<0>>(?:\s*<<1>>)?/.source, [F, M]), O = t(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [c, C]), P = /\[\s*(?:,\s*)*\]/.source, J = t(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [O, P]), ee = t(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [M, E, P]), p = t(/\(<<0>>+(?:,<<0>>+)+\)/.source, [ee]), d = t(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [p, O, P]), m = {
      keyword: o,
      punctuation: /[<>()?,.:[\]]/
    ...
    e.languages.csharp = e.languages.extend("clike", {
      ...
      "class-name": [
        ...
        },
        {
          ...
          pattern: r(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [F, d]),
          lookbehind: !0,
          inside: m
        },
        {
        ...
        },
        {
          ...
          pattern: r(/\b<<0>>(?=\s+(?!<<1>>|with\s*\{)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [d, f, F]),
          inside: m
        }
      ],
      keyword: o,
      ...
      "type-list": {
        ...
        pattern: r(
          ...
          [s, C, F, d, o.source, E, /\bnew\s*\(\s*\)/.source]
        ),
        lookbehind: !0,
        inside: {
          "record-arguments": {
    ...
    var z = g + "|" + u, _ = t(/\/(?![*/])|\/\/[^\r\n]*[\r\n]|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>/.source, [z]), Z = a(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [_]), 2), U = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/.source, re = t(/<<0>>(?:\s*\(<<1>>*\))?/.source, [O, Z]);
    e.languages.insertBefore("csharp", "class-name", {
      attribute: {
        // Attributes
    ...
    var Se = /:[^}\r\n]+/.source, we = a(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [_]), 2), Te = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [we, Se]), xe = a(t(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [z]), 2), Ee = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [xe, Se]);
    function B(V, j) {
      return {
        interpolation: {
...
var Fa = {}, Oa;
function Ys() {
  return Oa || (Oa = 1, Prism.languages.python = {
    comment: {
      pattern: /(^|[^\\])#.*/,
      lookbehind: !0,
      greedy: !0
    ...
    operator: /[-+%=]=?|!=|:=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
    punctuation: /[{}[\];(),.:]/
  }, Prism.languages.python["string-interpolation"].inside.interpolation.inside.rest = Prism.languages.python, Prism.languages.py = Prism.languages.python), Fa;
}
Ys();
        ...
        function s(o) {
          for (var c = 0; c < o.length && !(n >= i.length); c++) {
            ...
            if (typeof f == "string" || f.content && typeof f.content == "string") {
              var M = i[n], E = r.tokenStack[M], F = typeof f == "string" ? f : f.content, C = t(a, M), O = F.indexOf(C);
              if (O > -1) {
                ++n;
                var P = F.substring(0, O), J = new e.Token(a, e.tokenize(E, r.grammar), "language-" + a, E), ee = F.substring(O + C.length), p = [];
                P && p.push.apply(p, s([P])), p.push(J), ee && p.push.apply(p, s([ee])), typeof f == "string" ? o.splice.apply(o, [c, 1].concat(p)) : f.content = p;
              }
...
const Xt = (e, t) => v`<li title=${e || N} class="my-3 rounded-sm bg-white px-2 py-3 shadow-sm">${t}</li>`, Ge = (e, t) => v`<p title=${t || N}>${e}</p>`, zn = (e) => v`<div class="mt-2 mr-6 mb-6 flex flex-col gap-4">${e}</div>`, Q = (e, t) => v`<span role="img" aria-label="${t}">${e}</span>`, eo = ":host([mode=closed]){height:0}:host([mode=half]){height:var(--spacing-drawer-half-open)}:host([mode=open]){height:50%}";
var Tn = Object.defineProperty, to = Object.getOwnPropertyDescriptor, En = (e) => {
  throw TypeError(e);
}, ro = (e, t, r) => t in e ? Tn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, zt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? to(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && Tn(t, r, n), n;
}, Pn = (e, t, r) => ro(e, typeof t != "symbol" ? t + "" : t, r), Fn = (e, t, r) => t.has(e) || En("Cannot " + r), It = (e, t, r) => (Fn(e, t, "read from private field"), t.get(e)), dr = (e, t, r) => t.has(e) ? En("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), ja = (e, t, r, a) => (Fn(e, t, "write to private field"), t.set(e, r), r), jt, wt, kr;
const ao = 120;
let Xe = class extends Ze {
  constructor() {
    super(), dr(this, jt), dr(this, wt), Pn(this, "toggleReadMore", (e) => {
      this.mode === "open" ? this.mode = "half" : this.mode = "open", e.preventDefault(), e.stopImmediatePropagation();
    }), dr(this, kr, (e) => {
      e.key === "Escape" && (this.mode = "closed");
    }), this.mode = "closed", this.hasDetail = !1, ja(this, wt, new AbortController()), ja(this, jt, new Us(this, {
      callback: (e) => {
  ...
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("keydown", It(this, kr), { signal: It(this, wt).signal });
  }
  disconnectedCallback() {
    It(this, wt).abort(), super.disconnectedCallback();
  }
  render() {
    const e = this.mode === "open", t = It(this, jt).value;
...
function Dn({ fileName: e, location: t }) {
  return e ? `${e}${t ? `:${t.start.line}:${t.start.column}` : ""}` : "";
}
function Bn(e) {
  e && !so(e) && e.scrollIntoView({ block: "center", behavior: "smooth" });
}
function so(e) {
  const { top: t, bottom: r } = e.getBoundingClientRect();
  return t >= 0 && r <= (window.innerHeight || document.documentElement.clientHeight) - ao;
}
const jn = new un(), oo = St ? dn : Rs(_s(1), Mt(window, "hashchange").pipe(qs((e) => e.preventDefault()))).pipe(
  Kr(() => window.location.hash.substr(1).split("/").filter(Boolean).map(decodeURIComponent))
);
var be = /* @__PURE__ */ ((e) => (e.mutant = "mutant", e.test = "test", e))(be || {});
class je extends Ze {
  shouldReactivate() {
    return !0;
  }
...
let de = class extends je {
  ...
  firstUpdated() {
    (this.path.length === 0 || this.path[0] !== be.mutant && this.path[0] !== be.test) && window.location.replace(ct(`${be.mutant}`));
  }
  async loadData() {
    if (this.src)
      try {
  ...
  getTheme() {
    const e = xa() && localStorage.getItem("mutation-testing-elements-theme");
    return e || (St || window.matchMedia?.("(prefers-color-scheme: dark)")?.matches ? "dark" : "light");
  }
  updateModel(e) {
    this.rootModel = qi(e), t((r, a) => {
  ...
  updateContext() {
    if (this.rootModel) {
      ...
      this.path[0] === be.test && this.rootModel.testMetrics ? this.context = {
        view: be.test,
        path: t,
  ...
  connectedCallback() {
    super.connectedCallback(), window.matchMedia("(prefers-color-scheme: dark)").addEventListener?.("change", hr(this, _r), { signal: hr(this, Rt).signal }), this.subscriptions.push(oo.subscribe((e) => this.path = e)), this.initializeSse();
  }
  initializeSse() {
    if (!this.sse)
      return;
    ...
    }), t = Mt(this.source, "mutant-tested").pipe(Ns(ho)).subscribe(() => {
      this.applyChanges();
    });
  ...
  applyChanges() {
    this.theMutant?.update(), this.theTest?.update(), jn.next();
  }
  disconnectedCallback() {
...
var ve = /* @__PURE__ */ ((e) => (e.csharp = "cs", e.java = "java", e.javascript = "javascript", e.html = "html", e.php = "php", e.scala = "scala", e.typescript = "typescript", e.vue = "vue", e.gherkin = "gherkin", e.svelte = "svelte", e.rust = "rust", e.python = "python", e))(ve || {});
function fo(e) {
...
function Cr(e, t) {
  ...
  let s = !1, o = 0;
  for (; o < e.length; ) {
    switch (s && !Lt(e[o]) && (f(), s = !1), e[o]) {
      case "\r":
        n.offset++;
        break;
      case `
`:
        F(), n.offset++, n.line++, n.column = 0, s = !0;
        break;
      case "<": {
        const u = O();
        u.isClosing ? J(u) : P(u);
  ...
  function O() {
    ...
    for (; !Lt(e[o]) && e[o] !== ">"; )
      o++;
    const w = e.substring(g, o), z = ee();
    return { elementName: w, attributes: z, isClosing: u };
  }
  function P(u) {
    i.push(u), c(E(u));
  }
...
let ze = class extends je {
  constructor() {
    super(), gr(this, qt), gr(this, kt), gr(this, Mr, (e) => {
      ...
      if (e.stopPropagation(), e.target instanceof Element) {
        ...
        r[a] ? (this.toggleMutant(r[a]), Ua()) : this.selectedMutant && (this.toggleMutant(this.selectedMutant), Ua());
      }
    }), xt(this, "nextMutant", () => {
      ...
      this.mutants[e] && this.toggleMutant(this.mutants[e]);
    }), this.filters = [], this.selectedMutantStates = [], this.lines = [], this.mutants = [], wo(this, kt, new AbortController());
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("keydown", fr(this, Mr), { signal: fr(this, kt).signal });
  }
  disconnectedCallback() {
    fr(this, kt).abort(), super.disconnectedCallback();
  }
  render() {
  ...
  renderMutantDots(e) {
    return e?.length ? e.map(
      (t) => X`<svg mutant-id="${t.id}" class="mutant-dot mx-0.5 cursor-pointer ${this.selectedMutant?.id === t.id ? "selected" : ""} ${t.status}" height="10" width="12">
              <title>${qa(t)}</title>
              ${this.selectedMutant?.id === t.id ? Zn : Vn}
          </svg>`
    ) : N;
  }
  toggleMutant(e) {
    if (this.removeCurrentDiff(), La(this, qt, Ar).call(this, e), this.selectedMutant === e) {
      this.selectedMutant = void 0, this.dispatchEvent(Me("mutant-selected", { selected: !1, mutant: e }));
      return;
    } else this.selectedMutant && La(this, qt, Ar).call(this, this.selectedMutant);
    ...
    a.insertAdjacentHTML("afterend", r), Bn(a), this.dispatchEvent(Me("mutant-selected", { selected: !0, mutant: e }));
  }
  removeCurrentDiff() {
    const e = this.code;
    e.querySelectorAll(`.${mr}`).forEach((a) => a.classList.remove(mr)), e.querySelectorAll(`.${Na}`).forEach((a) => a.remove());
  }
  reactivate() {
  ...
  highlightedReplacementRows(e) {
    const t = e.getMutatedLines().trimEnd(), r = e.getOriginalLines().trimEnd(), [a, n] = go(r, t), i = Cr(Sr(t, this.model.name), function* ({ offset: c }) {
    ...
    }), s = `<tr class="${Na}"><td class="empty-line-number"></td><td class="line-marker"></td><td class="code">`, o = "</td></tr>";
...
Ar = function(e) {
  Wn(this.code, "mutant-id", e.id);
};
xt(ze, "styles", [An, De, Ue(mo)]);
Ve([
  ge()
], ze.prototype, "filters", 2);
Ve([
  T({ attribute: !1 })
], ze.prototype, "model", 2);
Ve([
  ge()
], ze.prototype, "selectedMutantStates", 2);
Ve([
  ge()
], ze.prototype, "selectedMutant", 2);
Ve([
  ge()
], ze.prototype, "lines", 2);
Ve([
  ge()
], ze.prototype, "mutants", 2);
Ve([
  ir("code")
], ze.prototype, "code", 2);
ze = Ve([
...
var Ut = { exports: {} }, xo = Ut.exports, Ha;
function ko() {
  return Ha || (Ha = 1, function(e) {
    ((t, r) => {
      ...
      var r = (h, l) => {
        ...
        xe(l) || (l = C(l));
        var k = b.bitflags;
        return (k & l._bitflags) !== k ? j : J(b, l);
      }, a = (h, l, b) => {
        if (!h) return b?.all ? P(l, b) : V;
        var k = O(h), $ = k.bitflags, x = k.containsSpace, y = E(b?.threshold || 0), A = b?.limit || Ee, S = 0, I = 0, R = l.length;
        function pe(We) {
          S < A ? (at.add(We), ++S) : (++I, We._score > at.peek()._score && at.replaceTop(We));
        }
        if (b?.key)
          for (var ie = b.key, q = 0; q < R; ++q) {
            var ue = l[q], H = Te(ue, ie);
            if (H && (xe(H) || (H = C(H)), ($ & H._bitflags) === $)) {
              var W = J(k, H);
              W !== j && (W._score < y || (W.obj = ue, pe(W)));
            }
          }
        else if (b?.keys) {
          ...
          e: for (var q = 0; q < R; ++q) {
            var ue = l[q];
            {
              for (var se = 0, L = 0; L < ke; ++L) {
                var ie = Re[L], H = Te(ue, ie);
                if (!H) {
                  Se[L] = le;
                  continue;
                }
                xe(H) || (H = C(H)), Se[L] = H, se |= H._bitflags;
              }
              if (($ & se) !== $) continue;
            }
            if (x) for (let K = 0; K < k.spaceSearches.length; K++) U[K] = B;
            for (var L = 0; L < ke; ++L) {
              if (H = Se[L], H === le) {
                we[L] = le;
                continue;
              ...
              if (x) for (let G = 0; G < k.spaceSearches.length; G++) {
                if (re[G] > -1e3 && U[G] > B) {
                  var ne = (U[G] + re[G]) / 4;
                  ne > U[G] && (U[G] = ne);
                }
            ...
            if (x) {
              for (let K = 0; K < k.spaceSearches.length; K++)
                if (U[K] === B) continue e;
            } else {
              var D = !1;
              for (let K = 0; K < ke; K++)
            ...
            if (x) {
              var te = 0;
              for (let K = 0; K < k.spaceSearches.length; K++) te += U[K];
            } else {
              var te = B;
              for (let G = 0; G < ke; G++) {
                var W = me[G];
        ...
        if (S === 0) return V;
        for (var Le = new Array(S), q = S - 1; q >= 0; --q) Le[q] = at.poll();
        return Le.total = S + I, Le;
      }, n = (h, l = "<b>", b = "</b>") => {
        for (var k = typeof l == "function" ? l : void 0, $ = h.target, x = $.length, y = h.indexes, A = "", S = 0, I = 0, R = !1, pe = [], ie = 0; ie < x; ++ie) {
          var q = $[ie];
          if (y[I] === ie) {
            if (++I, R || (R = !0, k ? (pe.push(A), A = "") : A += l), I === y.length) {
              k ? (A += q, pe.push(k(A, S++)), A = "", pe.push($.substr(ie + 1))) : A += q + b + $.substr(ie + 1);
              break;
            }
          } else
            R && (R = !1, k ? (pe.push(k(A, S++)), A = "") : A += b);
          A += q;
        }
        return k ? pe : A;
      }, i = (h) => {
      ...
      var f = (h, l) => {
        const b = new o();
        return b.target = h, b.obj = l.obj ?? j, b._score = l._score ?? B, b._indexes = l._indexes ?? [], b._targetLower = l._targetLower ?? "", b._targetLowerCodes = l._targetLowerCodes ?? j, b._nextBeginningIndexes = l._nextBeginningIndexes ?? j, b._bitflags = l._bitflags ?? 0, b;
      }, M = (h) => h === B ? 0 : h > 1 ? h : Math.E ** (((-h + 1) ** 0.04307 - 1) * -2), E = (h) => h === 0 ? B : h > 1 ? h : 1 - Math.pow(Math.log(h) / -2 + 1, 1 / 0.04307), F = (h) => {
        ...
        if (l.containsSpace) {
          ...
          for (var $ = 0; $ < k.length; $++)
            if (k[$] !== "") {
              var x = d(k[$]);
              b.push({ lowerCodes: x.lowerCodes, _lower: k[$].toLowerCase(), containsSpace: !1 });
            }
        }
        ...
        if (h.length > 999) return F(h);
        var l = w.get(h);
        return l !== void 0 || (l = F(h), w.set(h, l)), l;
      }, P = (h, l) => {
        var b = [];
        b.total = h.length;
        var k = l?.limit || Ee;
        if (l?.key)
          for (var $ = 0; $ < h.length; $++) {
            var x = h[$], y = Te(x, l.key);
            if (y != j) {
              xe(y) || (y = C(y));
              var A = f(y.target, { _score: y._score, obj: x });
              if (b.push(A), b.length >= k) return b;
            }
          }
        else if (l?.keys)
          for (var $ = 0; $ < h.length; $++) {
            for (var x = h[$], S = new c(l.keys.length), I = l.keys.length - 1; I >= 0; --I) {
              var y = Te(x, l.keys[I]);
              if (!y) {
                S[I] = le;
                continue;
              }
              xe(y) || (y = C(y)), y._score = B, y._indexes.len = 0, S[I] = y;
            }
            if (S.obj = x, S._score = B, b.push(S), b.length >= k) return b;
          }
        else
          for (var $ = 0; $ < h.length; $++) {
            var y = h[$];
            if (y != j && (xe(y) || (y = C(y)), y._score = B, y._indexes.len = 0, b.push(y), b.length >= k))
              return b;
          }
        return b;
      }, J = (h, l, b = !1, k = !1) => {
        if (b === !1 && h.containsSpace) return ee(h, l, k);
        for (var $ = h._lower, x = h.lowerCodes, y = x[0], A = l._targetLowerCodes, S = x.length, I = A.length, q = 0, R = 0, pe = 0; ; ) {
          var ie = y === A[R];
          if (ie) {
            if (z[pe++] = R, ++q, q === S) break;
            y = x[q];
          }
          if (++R, R >= I) return j;
        }
        var q = 0, ue = !1, H = 0, W = l._nextBeginningIndexes;
        W === j && (W = l._nextBeginningIndexes = u(l.target)), R = z[0] === 0 ? 0 : W[z[0] - 1];
        var Re = 0;
        if (R !== I) for (; ; )
          if (R >= I) {
        ...
        var se = S <= 1 ? -1 : l._targetLower.indexOf($, z[0]), L = !!~se, ne = L ? se === 0 || l._nextBeginningIndexes[se - 1] === se : !1;
        if (L && !ne) {
          for (var D = 0; D < W.length; D = W[D])
            if (!(D <= se)) {
              for (var me = 0; me < S && x[me] === l._targetLowerCodes[D + me]; me++) ;
              if (me === S) {
                se = D, ne = !0;
                break;
              }
        ...
        var te = (K) => {
          for (var G = 0, la = 0, Pe = 1; Pe < S; ++Pe)
            K[Pe] - K[Pe - 1] !== 1 && (G -= K[Pe], ++la);
          var Ai = K[S - 1] - K[0] - (S - 1);
          if (G -= (12 + Ai) * la, K[0] !== 0 && (G -= K[0] * K[0] * 0.2), !ue)
            G *= 1e3;
          else {
            for (var sr = 1, Pe = W[0]; Pe < I; Pe = W[Pe]) ++sr;
            sr > 24 && (G *= (sr - 24) * 10);
          }
          return G -= (I - S) / 2, L && (G /= 1 + S * S * 1), ne && (G /= 1 + S * S * 1), G -= (I - S) / 2, G;
        };
        if (ue)
          if (ne) {
            for (var D = 0; D < S; ++D) z[D] = se + D;
            var Le = z, We = te(z);
          } else
            var Le = _, We = te(_);
        else {
          if (L) for (var D = 0; D < S; ++D) z[D] = se + D;
          var Le = z, We = te(Le);
        }
        l._score = We;
        for (var D = 0; D < S; ++D) l._indexes[D] = Le[D];
        l._indexes.len = S;
        const Ft = new o();
        return Ft.target = l.target, Ft._score = l._score, Ft._indexes = l._indexes, Ft;
      }, ee = (h, l, b) => {
        for (var k = /* @__PURE__ */ new Set(), $ = 0, x = j, y = 0, A = h.spaceSearches, S = A.length, I = 0, R = () => {
          ...
          $ += x._score / S, re[L] = x._score / S, x._indexes[0] < y && ($ -= (y - x._indexes[0]) * 2), y = x._indexes[0];
          for (var ke = 0; ke < x._indexes.len; ++ke) k.add(x._indexes[ke]);
        }
        if (b && !pe) return j;
        R();
        var se = J(
        ...
        b && (x = l), x._score = $;
        var L = 0;
        for (let ne of k) x._indexes[L++] = ne;
        return x._indexes.len = L, x;
      }, p = (h) => h.replace(new RegExp("\\p{Script=Latin}+", "gu"), (l) => l.normalize("NFD")).replace(/[\u0300-\u036f]/g, ""), d = (h) => {
        h = p(h);
        for (var l = h.length, b = h.toLowerCase(), k = [], $ = 0, x = !1, y = 0; y < l; ++y) {
          var A = k[y] = b.charCodeAt(y);
          if (A === 32) {
            x = !0;
            continue;
          }
          var S = A >= 97 && A <= 122 ? A - 97 : A >= 48 && A <= 57 ? 26 : A <= 127 ? 30 : 31;
          $ |= 1 << S;
        }
        return { lowerCodes: k, bitflags: $, containsSpace: x, _lower: b };
      }, m = (h) => {
        for (var l = h.length, b = [], k = 0, $ = !1, x = !1, y = 0; y < l; ++y) {
          var A = h.charCodeAt(y), S = A >= 65 && A <= 90, I = S || A >= 97 && A <= 122 || A >= 48 && A <= 57, R = S && !$ || !x || !I;
          $ = S, x = I, R && (b[k++] = y);
        }
        return b;
      }, u = (h) => {
        h = p(h);
        for (var l = h.length, b = m(h), k = [], $ = b[0], x = 0, y = 0; y < l; ++y)
          $ > y ? k[y] = $ : ($ = b[++x], k[y] = $ === void 0 ? l : $);
        return k;
      }, g = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), z = [], _ = [], Z = [], U = [], re = [], Se = [], we = [], Te = (h, l) => {
        var b = h[l];
        if (b !== void 0) return b;
        if (typeof l == "function") return l(h);
        var k = l;
        Array.isArray(l) || (k = l.split("."));
        for (var $ = k.length, x = -1; h && ++x < $; ) h = h[k[x]];
        return h;
      }, xe = (h) => typeof h == "object" && typeof h._bitflags == "number", Ee = 1 / 0, B = -Ee, V = [];
      V.total = 0;
      var j = null, le = i(""), ce = (h) => {
        var l = [], b = 0, k = {}, $ = (x) => {
          for (var y = 0, A = l[y], S = 1; S < b; ) {
            var I = S + 1;
            y = S, I < b && l[I]._score < l[S]._score && (y = I), l[y - 1 >> 1] = l[y], S = 1 + (y << 1);
          }
          for (var R = y - 1 >> 1; y > 0 && A._score < l[R]._score; R = (y = R) - 1 >> 1) l[y] = l[R];
          l[y] = A;
        };
        return k.add = (x) => {
          var y = b;
          l[b++] = x;
          for (var A = y - 1 >> 1; y > 0 && x._score < l[A]._score; A = (y = A) - 1 >> 1) l[y] = l[A];
          l[y] = x;
        }, k.poll = (x) => {
          if (b !== 0) {
            var y = l[0];
...
`, Qn = (e) => X`<svg aria-hidden="true" class="${e} h-4 w-4" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
  <path
    fill-rule="evenodd"
    d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
    clip-rule="evenodd"
  ></path>
</svg>`, Co = Qn("rotate-180"), Mo = Qn();
var Xn = Object.defineProperty, Ao = Object.getOwnPropertyDescriptor, ei = (e) => {
  throw TypeError(e);
}, zo = (e, t, r) => t in e ? Xn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Tt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Ao(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && Xn(t, r, n), n;
}, Ka = (e, t, r) => zo(e, typeof t != "symbol" ? t + "" : t, r), Yr = (e, t, r) => t.has(e) || ei("Cannot " + r), _e = (e, t, r) => (Yr(e, t, "read from private field"), t.get(e)), Fe = (e, t, r) => t.has(e) ? ei("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), ti = (e, t, r, a) => (Yr(e, t, "write to private field"), t.set(e, r), r), $e = (e, t, r) => (Yr(e, t, "access private method"), r), Ht, ut, Kt, he, ri, ai, ni, zr, ii, si, oi, li, Tr, Er, Pr, Fr, Zt, Jr;
let dt = class extends Ze {
  constructor() {
    super(), Fe(this, he), Fe(this, Ht, new AbortController()), Fe(this, ut, []), Fe(this, Kt, ""), Ka(this, "open", () => {
      this.dialog.showModal();
    }), Ka(this, "close", () => {
      this.dialog.close();
    }), Fe(this, zr, (e) => {
      ((e.ctrlKey || e.metaKey) && e.key === "k" || !this.isOpen && e.key === "/") && _e(this, Tr).call(this, e), this.isOpen && (e.key === "ArrowUp" ? $e(this, he, oi).call(this) : e.key === "ArrowDown" && $e(this, he, si).call(this), (e.key === "ArrowUp" || e.key === "ArrowDown") && this.updateComplete.then(() => {
        $e(this, he, ii).call(this);
      }), e.key === "Enter" && $e(this, he, li).call(this));
    }), Fe(this, Tr, (e = null) => {
  ...
  connectedCallback() {
    super.connectedCallback(), ti(this, Kt, document.body.style.overflow), window.addEventListener("keydown", _e(this, zr), { signal: _e(this, Ht).signal });
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Gr.cleanup(), _e(this, Ht).abort();
  }
  willUpdate(e) {
    e.has("rootModel") && ($e(this, he, ni).call(this), $e(this, he, Zt).call(this, ""));
  }
  render() {
    return v`
      <dialog
      ...
      >
        ...
        >
          <div class="mb-3 flex items-center rounded-sm bg-gray-200/60 p-2 text-gray-800 shadow-lg">
            <div class="mx-2 flex items-center">${Jn}</div>
      ...
      return v`
              ...
              >
                <a
                  ...
                  href="${ct(n, e)}"
                >
                  <span class="inline-flex" title="File with ${n}s">${$e(this, he, ai).call(this, n)}</span>
...
Jr = function(e) {
  return e instanceof tn ? be.test : be.mutant;
};
Tt([
  T({ attribute: !1 })
...
var To = Object.defineProperty, Eo = Object.getOwnPropertyDescriptor, ci = (e) => {
  throw TypeError(e);
}, Qr = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Eo(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && To(t, r, n), n;
}, Po = (e, t, r) => t.has(e) || ci("Cannot " + r), Fo = (e, t, r) => t.has(e) ? ci("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Ye = (e, t, r) => (Po(e, t, "access private method"), r), Ie, ui, Xr, ea, di, pi;
let er = class extends Ze {
  constructor() {
    super(...arguments), Fo(this, Ie);
  }
  get rootName() {
    switch (this.view) {
      case be.mutant:
  ...
  render() {
    return v`<nav class="my-4 flex rounded-md border border-primary-600 bg-primary-100 p-3 text-gray-700" aria-label="Breadcrumb">
      <ol class="inline-flex items-center">
        ...
        ${Ye(this, Ie, ui).call(this)}
      </ol>
      ${Ye(this, Ie, di).call(this)}
    </nav> `;
  }
};
...
di = function() {
  return v`
      <button @click="${() => Ye(this, Ie, pi).call(this)}" class="ml-auto" title="Open file picker (Ctrl-K)">${Jn}</button>
    `;
};
pi = function() {
...
var hi = Object.defineProperty, Oo = Object.getOwnPropertyDescriptor, fi = (e) => {
  throw TypeError(e);
}, Io = (e, t, r) => t in e ? hi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, gi = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Oo(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && hi(t, r, n), n;
}, Za = (e, t, r) => Io(e, typeof t != "symbol" ? t + "" : t, r), Do = (e, t, r) => t.has(e) || fi("Cannot " + r), Bo = (e, t, r) => t.has(e) ? fi("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Va = (e, t, r) => (Do(e, t, "access private method"), r), Vt, Or;
let Ir = class extends je {
  constructor() {
    super(...arguments), Bo(this, Vt), Za(this, "next", (e) => {
    ...
    return v`
      <div class="sticky top-offset z-10 mb-1 flex flex-row gap-5 bg-white py-6 pt-7">
        <div class="flex items-center gap-2">
          ${Va(this, Vt, Or).call(this, this.previous, Co, "Previous", "Select previous mutant")}
          ${Va(this, Vt, Or).call(this, this.next, Mo, "Next", "Select next mutant")}
        </div>
...
const bi = ({ hasDetail: e, mode: t }, r) => v`<mte-drawer
...
var qo = Object.defineProperty, Uo = Object.getOwnPropertyDescriptor, ta = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Uo(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && qo(t, r, n), n;
};
const Wa = (e) => `${e.name}${e.sourceFile && e.location ? ` (${Dn(e)})` : ""}`, Ga = (e) => v`<span class="whitespace-pre-wrap">${e}</span>`;
let rr = class extends je {
  constructor() {
      ...
      _t(
        ...
        (e) => v`
          <span class="align-middle text-lg" slot="header"
            >${On(e.status)} ${e.mutatorName} ${e.status}
    ...
    return zn(
      ...
      ${_t(
        ...
        (e) => Ge(
          ...
          test${In(e)}${this.mutant?.status === "Survived" ? " (yet still survived)" : ""}`
        )
      )}
      ${lt(
        this.mutant?.statusReason?.trim(),
        Ge(
          v`${Q("🕵️", "spy")} ${Ga(this.mutant.statusReason)}`,
  ...
  renderDetail() {
    return v`<ul class="mr-2 mb-6">
      ...
      (e) => Xt("This mutant was killed by this test", v`${Q("🎯", "killed")} ${Wa(e)}`)
    )}
      ${Ne(
      this.mutant?.coveredByTests?.filter((e) => !this.mutant?.killedByTests?.includes(e)),
      (e) => Xt("This mutant was covered by this test", v`${Q("☂️", "umbrella")} ${Wa(e)}`)
    )}
    </ul>`;
  }
};
...
var Ho = Object.defineProperty, Ko = Object.getOwnPropertyDescriptor, mt = (e, t, r, a) => {
  ...
  render() {
    return v`
      <main class="pb-drawer-half-open" @click="${this.handleClick}">
        <mte-metrics-table .columns="${Zo}" .currentPath="${this.path}" .thresholds="${this.thresholds}" .model="${this.result}">
        </mte-metrics-table>
...
var Vo = Object.defineProperty, Wo = Object.getOwnPropertyDescriptor, Et = (e, t, r, a) => {
...
var Yo = Object.defineProperty, Jo = Object.getOwnPropertyDescriptor, Pt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Jo(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && Yo(t, r, n), n;
};
...
const Qo = '#report-code-block{background:var(--prism-background);border:1px solid var(--prism-border);overflow:auto visible}.line-numbers{counter-reset:mte-line-number}.line .line-number{text-align:right;color:var(--mut-line-number);counter-increment:mte-line-number;padding:0 10px 0 15px}.line .line-number:before{content:counter(mte-line-number)}.line-marker:before{content:" ";padding:0 5px}.Killing{--mut-test-dot-color:var(--color-green-700)}.Covering{--mut-test-dot-color:var(--color-amber-400)}.NotCovering{--mut-test-dot-color:var(--color-orange-500)}svg.test-dot{fill:var(--mut-test-dot-color)}';
var yi = Object.defineProperty, Xo = Object.getOwnPropertyDescriptor, wi = (e) => {
  throw TypeError(e);
}, el = (e, t, r) => t in e ? yi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, rt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Xo(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && yi(t, r, n), n;
}, Wt = (e, t, r) => el(e, typeof t != "symbol" ? t + "" : t, r), ra = (e, t, r) => t.has(e) || wi("Cannot " + r), yt = (e, t, r) => (ra(e, t, "read from private field"), t.get(e)), Dt = (e, t, r) => t.has(e) ? wi("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), tl = (e, t, r, a) => (ra(e, t, "write to private field"), t.set(e, r), r), Ya = (e, t, r) => (ra(e, t, "access private method"), r), $t, Dr, Gt, Yt, Br;
let Be = class extends je {
  constructor() {
    ...
    }), this.filters = [], this.lines = [], this.enabledStates = [], this.tests = [], tl(this, $t, new AbortController());
  }
  connectedCallback() {
  ...
  toggleTest(e) {
    Ya(this, Yt, Br).call(this, e), this.selectedTest === e ? (this.selectedTest = void 0, this.dispatchEvent(Me("test-selected", { selected: !1, test: e }))) : (this.selectedTest && Ya(this, Yt, Br).call(this, this.selectedTest), this.selectedTest = e, this.dispatchEvent(Me("test-selected", { selected: !0, test: e })), Bn(this.renderRoot.querySelector(`[test-id="${e.id}"]`)));
  }
  selectTest(e) {
    e && this.toggleTest(e);
  }
...
Br = function(e) {
  Wn(this.renderRoot, "test-id", e.id);
};
Wt(Be, "styles", [An, De, Ue(Qo)]);
rt([
  T({ attribute: !1 })
...
var al = Object.defineProperty, nl = Object.getOwnPropertyDescriptor, aa = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? nl(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && al(t, r, n), n;
};
const vr = (e) => v`<code>${e.getMutatedLines()}</code> (${Dn(e)})`;
let ar = class extends je {
  constructor() {
    super(), this.mode = "closed";
  }
  render() {
    ...
    return zn(
      ...
      ${_t(
        ...
        (e) => Ge(
          ...
          mutant${In(e)}${this.test?.status === ae.Covering ? " (yet didn't kill any of them)" : ""}`
        )
      )}`
    );
  }
...
var cl = Object.defineProperty, ul = Object.getOwnPropertyDescriptor, ki = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? ul(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && cl(t, r, n), n;
};
let jr = class extends Ze {
  render() {
...
class dl {
  constructor(t, { target: r, config: a, callback: n, skipInitial: i }) {
    this.t = /* @__PURE__ */ new Set(), this.o = !1, this.i = !1, this.h = t, r !== null && this.t.add(r ?? t), this.o = i ?? this.o, this.callback = n, Qa || (window.IntersectionObserver ? (this.u = new IntersectionObserver((s) => {
      const o = this.i;
...
var pl = Object.defineProperty, hl = Object.getOwnPropertyDescriptor, $i = (e) => {
  throw TypeError(e);
}, vt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? hl(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && pl(t, r, n), n;
}, ia = (e, t, r) => t.has(e) || $i("Cannot " + r), fl = (e, t, r) => (ia(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Ja = (e, t, r) => t.has(e) ? $i("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), gl = (e, t, r, a) => (ia(e, t, "write to private field"), t.set(e, r), r), qe = (e, t, r) => (ia(e, t, "access private method"), r), nr, Ae, _i, Si, sa, oa, Ci, Mi;
let tt = class extends Ze {
  constructor() {
    super(), Ja(this, Ae), Ja(this, nr), this.detected = 0, this.noCoverage = 0, this.pending = 0, this.survived = 0, this.total = 0, gl(this, nr, new dl(this, {
      callback: ([e]) => !e.isIntersecting
    }));
  }
  render() {
    return v`
      ${qe(this, Ae, _i).call(this)}
      <div class="my-4 rounded-md border border-gray-200 bg-white transition-all">
        <div class="parts flex h-8 w-full overflow-hidden rounded-sm bg-gray-200">${qe(this, Ae, Si).call(this)}</div>
      </div>
    `;
  }
};
...
_i = function() {
  return v`<div
      class="${fl(this, nr).value ? "opacity-100" : "opacity-0"} pointer-events-none fixed top-offset left-0 z-20 flex w-full justify-center transition-all"
    >
      <div class="container w-full bg-white py-2">
        <div class="flex h-2 overflow-hidden rounded-sm bg-gray-200">${qe(this, Ae, oa).call(this).map((e) => qe(this, Ae, sa).call(this, e, !0))}</div>
      </div>
    </div>`;
};
Si = function() {
  return qe(this, Ae, oa).call(this).map((e) => qe(this, Ae, sa).call(this, e, !1));
};
sa = function(e, t) {
  return v`<div
      title="${t ? N : e.tooltip}"
      style="width: ${qe(this, Ae, Mi).call(this, e.amount)}%"
      class="${qe(this, Ae, Ci).call(this, e.type)} ${e.amount === 0 ? "opacity-0" : "opacity-100"} relative flex items-center overflow-hidden"

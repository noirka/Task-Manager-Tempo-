...
function getDB() {
  if (stryMutAct_9fa48("19")) {
    ...
    stryCov_9fa48("19");
    if (stryMutAct_9fa48("22") ? false : stryMutAct_9fa48("21") ? true : stryMutAct_9fa48("20") ? db : (stryCov_9fa48("20", "21", "22"), !db)) {
      if (stryMutAct_9fa48("23")) {
        {}
      } else {
        stryCov_9fa48("23");
        throw new Error(stryMutAct_9fa48("24") ? "" : (stryCov_9fa48("24"), 'Database not initialized. Call connectDB first.'));
      }
    }
    return db;
  }
}
module.exports = stryMutAct_9fa48("25") ? {} : (stryCov_9fa48("25"), {
  connectDB,
  getDB
});